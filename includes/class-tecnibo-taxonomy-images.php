 ...
 * 
 */
if ( !class_exists( 'Tecnibo_Taxonomy_Images' ) ) {

    class Tecnibo_Taxonomy_Images {
        ...
        public function init() {
            // Image actions
            add_action('product_category_add_form_fields', array($this, 'add_product_category_image'), 10, 2);
            add_action('created_product_category', array($this, 'save_product_category_image'), 10, 2);
            add_action('product_category_edit_form_fields', array($this, 'update_product_category_image'), 10, 2);
            add_action('edited_product_category', array($this, 'updated_product_category_image'), 10, 2);
         ...
         * @since 1.0.0
         */
        public function add_product_category_image($taxonomy) {
            ?>
         ...
         * @since 1.0.0
         */
        public function save_product_category_image($term_id, $tt_id) {
         ...
         * @since 1.0.0
         */
        public function update_product_category_image($term, $taxonomy) {
            ?>
         ...
         * @since 1.0.0
         */
        public function updated_product_category_image($term_id, $tt_id) {
            if (isset($_POST['showcase-taxonomy-image-id']) && '' !== $_POST['showcase-taxonomy-image-id']) {
